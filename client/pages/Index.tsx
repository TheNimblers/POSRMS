    ...
    items: [
      {
        name: "Truffle Fries",
        price: 6.0,
        desc: "Parmesan, herbs, truffle oil",
      },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="mt-5 text-lg text-gray-600 max-w-xl">
                ...
                analytics — beautifully integrated and lightning fast.
              </p>
                ...
                <Tabs defaultValue="hero-customer" className="w-full">
                    ...
                    <div className="grid grid-cols-3 gap-3 mt-3">
                      ...
                      <Card>
                        <CardContent className="p-3">
                          ...
                          <div className="font-semibold">6m 20s</div>
                        </CardContent>
                      </Card>
                    </div>
                  </TabsContent>
                    ...
                    <div className="grid grid-cols-3 gap-3 mt-3">
                      ...
                      <Card>
                        <CardContent className="p-3">
                          ...
                          <div className="font-semibold text-amber-600">2</div>
                        </CardContent>
                      </Card>
                      <Card>
                        <CardContent className="p-3">
                  ...
                  <TabsContent value="hero-manager">
                    ...
                    <div className="grid grid-cols-3 gap-3 mt-3">
                      ...
                      <Card>
                        <CardContent className="p-3">
                          <div className="text-xs text-gray-500">Top Item</div>
                          <div className="font-semibold">Spicy Burger</div>
                        </CardContent>
                      </Card>
                      <Card>
                        <CardContent className="p-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card>
              <CardContent className="p-6">
                <div className="h-10 w-10 rounded-lg bg-orange-100 text-orange-700 flex items-center justify-center mb-3">
                  <LayoutGrid className="h-5 w-5" />
                </div>
                <h3 className="font-semibold">Unified Dashboards</h3>
                <p className="text-sm text-gray-600 mt-1">
                  Customer, Waiter, Kitchen, Bar, Manager — all streamlined.
                </p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  WebSocket-powered notifications for orders, tables, and
                  payments.
                </p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Request and confirm payments with a tap, track bill in
                  real-time.
                </p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Live sales, top items, utilization — right on your dashboard.
                </p>
              </CardContent>
            </Card>
          </div>
                      ...
                      <CardContent className="p-4">
                        ...
                        <div className="text-sm text-gray-600">
                          <div className="flex justify-between">
                            <span>2x Spicy Burger</span>
                            <span>$25.00</span>
                          </div>
                          <div className="flex justify-between">
                            <span>1x Mango Shake</span>
                            <span>$4.50</span>
                          </div>
                    ...
                    <Card>
                      <CardContent className="p-4">
                        ...
                        <div className="grid grid-cols-2 gap-3 text-sm">
                          <div>
                            <div className="text-gray-500">Avg Serve</div>
                            <div className="font-semibold">6m 20s</div>
                          </div>
                          <div>
                          ...
                          {kitchenQueue.map((k) => (
                            <li key={k.id}>
                              <div className="flex justify-between font-medium">
                                <span
                                  className={k.late ? "text-amber-700" : ""}
                                >
                                  #{k.id}
                                </span>
                                <span
                        ...
                        <ul className="text-sm text-gray-600 space-y-1">
                          {topItems.map((i) => (
                            <li key={i.name} className="flex justify-between">
                              <span>{i.name}</span>
                              <span>
                                {i.sales} orders • ${i.revenue.toLocaleString()}
                              </span>
                            </li>
                          ))}
                        </ul>
            ...
            <Card className="relative">
              ...
              <CardContent>
                <ul className="space-y-3 text-gray-600">
                  ...
                  <li className="flex items-center">
                    <Check className="h-4 w-4 text-green-600 mr-2" />2 staff
                    accounts
                  </li>
                  <li className="flex items-center">
                    <Check className="h-4 w-4 text-green-600 mr-2" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="border-l-4 border-l-emerald-500">
              <CardContent className="p-6 text-gray-700">
                “POSRMS cut our order wait-times by 30% and boosted table
                turns.”
            ...
            <Card className="border-l-4 border-l-orange-500">
              <CardContent className="p-6 text-gray-700">
                “Staff learned it in a day. The customer menu is gorgeous on
                mobile.”
            ...
            <Card className="border-l-4 border-l-purple-500">
              <CardContent className="p-6 text-gray-700">
                “Finally, a single system that connects customers, waiters, and
                kitchen.”
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-800 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400">
              © 2024 POSRMS. All rights reserved.
            </p>
...
function CoffeeIcon() {
  return (
    ...
    >
      <path
        d="M3 8h14a4 4 0 010 8h-1a6 6 0 01-12 0V8z"
        stroke="currentColor"
        strokeWidth="1.5"
      />
      <path d="M5 8V6a3 3 0 013-3h3" stroke="currentColor" strokeWidth="1.5" />
    </svg>
  );
}
