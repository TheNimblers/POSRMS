...
const mockDrinkOrders = [
  {
    ...
    tableNumber: 'T1',
    items: [
      { name: 'House Wine Red', quantity: 2, notes: 'Room temperature', category: 'wine' },
      { name: 'Craft Beer IPA', quantity: 1, notes: 'Extra cold', category: 'beer' }
    ],
    status: 'new',
  ...
  },
  {
    ...
    tableNumber: 'T2',
    items: [
      { name: 'Signature Cocktail', quantity: 2, notes: 'Extra ice, lime garnish', category: 'cocktail' },
      { name: 'Sparkling Water', quantity: 1, notes: '', category: 'non-alcoholic' }
    ],
    status: 'preparing',
  ...
  },
  {
    ...
    tableNumber: 'T5',
    items: [
      { name: 'House Wine White', quantity: 3, notes: 'Well chilled', category: 'wine' },
      { name: 'Fresh Orange Juice', quantity: 2, notes: 'No pulp', category: 'non-alcoholic' }
    ],
    status: 'preparing',
  ...
  },
  {
    ...
    tableNumber: 'T3',
    items: [
      { name: 'Whiskey Sour', quantity: 1, notes: 'Double whiskey', category: 'cocktail' }
    ],
    status: 'ready',
  ...
  },
  {
    ...
    tableNumber: 'T4',
    items: [
      { name: 'Mojito', quantity: 2, notes: 'Extra mint', category: 'cocktail' },
...
const getCategoryIcon = (category: string) => {
  switch (category) {
    ...
    case 'beer': return Beaker;
    case 'cocktail': return Coffee;
...
const getCategoryColor = (category: string) => {
  switch (category) {
    ...
    case 'cocktail': return 'bg-pink-100 text-pink-800';
    case 'non-alcoholic': return 'bg-blue-100 text-blue-800';
    default: return 'bg-gray-100 text-gray-800';
  }
};
...
export default function Bar() {
  ...
  useEffect(() => {
    ...
    if (user.role !== 'bar' && user.role !== 'admin' && user.role !== 'manager') {
      navigate('/login');
      return;
    }
  }, [user, navigate]);
                ...
                return (
                  <div key={index} className="bg-white/50 rounded p-2">
                    <div className="flex justify-between items-start">
                      ...
                      <Badge variant="outline" className={`text-xs ml-2 ${getCategoryColor(item.category)}`}>
                        {item.category}
                      </Badge>
                    </div>
                  </div>
          ...
          <Card className="bg-amber-800/50 backdrop-blur-sm border-amber-700/50">
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-amber-200">Preparing</p>
